...
enum TweakArray {
    static var tweaks: [ZeroSection] = [
        ...
        ZeroSection(name: "Home Screen", icon: "house", tweaks: [
            ZeroTweak(name: "Hide Dock Background", icon: "dock.rectangle", minSupportedVersion: 16.0, maxSupportedVersion: 26.9, paths: ["/System/Library/PrivateFrameworks/CoreMaterial.framework/dockDark.materialrecipe", "/System/Library/PrivateFrameworks/CoreMaterial.framework/dockLight.materialrecipe"]),
            ZeroTweak(name: "Clear Folder Backgrounds", icon: "folder", minSupportedVersion: 16.0, maxSupportedVersion: 26.9, paths: ["/System/Library/PrivateFrameworks/SpringBoardHome.framework/folderDark.materialrecipe", "/System/Library/PrivateFrameworks/SpringBoardHome.framework/folderLight.materialrecipe"]),
            ZeroTweak(name: "Clear Widget Config BG", icon: "square.text.square", minSupportedVersion: 16.0, maxSupportedVersion: 26.9, paths: ["/System/Library/PrivateFrameworks/SpringBoardHome.framework/stackConfigurationBackground.materialrecipe", "/System/Library/PrivateFrameworks/SpringBoardHome.framework/stackConfigurationForeground.materialrecipe"]),
        ...
        ZeroSection(name: "Lock Screen", icon: "lock", tweaks: [
            ZeroTweak(name: "Clear Passcode Background", icon: "ellipsis.rectangle", minSupportedVersion: 16.0, maxSupportedVersion: 26.9, paths: ["/System/Library/PrivateFrameworks/CoverSheet.framework/dashBoardPasscodeBackground.materialrecipe"]),
        ...
        ZeroSection(name: "Alerts & Overlays", icon: "platter.filled.top.iphone", tweaks: [
            ZeroTweak(name: "Clear Notification & Widget BGs", icon: "platter.filled.top.iphone", minSupportedVersion: 16.0, maxSupportedVersion: 26.9, paths: ["/System/Library/PrivateFrameworks/CoreMaterial.framework/platterStrokeLight.visualstyleset", "/System/Library/PrivateFrameworks/CoreMaterial.framework/platterStrokeDark.visualstyleset", "/System/Library/PrivateFrameworks/CoreMaterial.framework/plattersDark.materialrecipe", "/System/Library/PrivateFrameworks/CoreMaterial.framework/platters.materialrecipe", "/System/Library/PrivateFrameworks/UserNotificationsUIKit.framework/stackDimmingLight.visualstyleset", "/System/Library/PrivateFrameworks/UserNotificationsUIKit.framework/stackDimmingDark.visualstyleset"]),
            ZeroTweak(name: "Blue Notifcation Shadows", icon: "paintpalette", minSupportedVersion: 16.0, maxSupportedVersion: 26.9, paths: [
            ...
            ZeroTweak(name: "Clear Touch & Alert Backgrounds", icon: "list.bullet.rectangle", minSupportedVersion: 16.0, maxSupportedVersion: 26.9, paths: ["/System/Library/PrivateFrameworks/CoreMaterial.framework/platformContentDark.materialrecipe", "/System/Library/PrivateFrameworks/CoreMaterial.framework/platformContentLight.materialrecipe"]),
            ...
            ZeroTweak(name: "Remove Glassy Overlays", icon: "text.rectangle.page", minSupportedVersion: 16.0, maxSupportedVersion: 26.9, paths: ["/System/Library/PrivateFrameworks/CoreMaterial.framework/platformChromeDark.materialrecipe", "/System/Library/PrivateFrameworks/CoreMaterial.framework/platformChromeLight.materialrecipe"]),
        ...
        ZeroSection(name: "Fonts & Icons", icon: "paintbrush", tweaks: [
            ...
            ZeroTweak(name: "Disable Emojis", icon: "circle.slash", minSupportedVersion: 16.0, maxSupportedVersion: 26.9, paths: ["/System/Library/Fonts/CoreAddition/AppleColorEmoji-160px.ttc"]),
        ...
        ZeroSection(name: "Control Center", icon: "square.grid.2x2", tweaks: [
            ZeroTweak(name: "Clear CC Modules", icon: "circle.grid.2x2", minSupportedVersion: 18.0, maxSupportedVersion: 26.9, paths: ["/System/Library/PrivateFrameworks/CoreMaterial.framework/modulesSheer.descendantrecipe", "/System/Library/ControlCenter/Bundles/FocusUIModule.bundle/Info.plist"]),
        ...
        ZeroSection(name: "Risky Tweaks", icon: "exclamationmark.triangle.fill", tweaks: [
            ZeroTweak(name: "Remove CC Background", icon: "square.dashed", minSupportedVersion: 16.0, maxSupportedVersion: 26.9, paths: ["/System/Library/PrivateFrameworks/CoreMaterial.framework/modulesBackground.materialrecipe"]),
